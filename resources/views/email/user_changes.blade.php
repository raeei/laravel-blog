                        ...
                        <table class="column" style="background-color: white; width: 100%; border-spacing: 0; table-layout: fixed; border-radius: 3px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015);">
                            <tr >
                                <td style=" padding: 40px 20px 10px 20px;">
                                    <p style="font-size: 17px; color: #718096;">Hello <strong>{{$email_data['name']}}</strong>,</p>
                                </td>
                            </tr>
                            <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="color: #718096;"><strong>The {{$email_data['topic1']}} for your account on myBlog has been changed.</strong></p>
                                </td>
                               
                            </tr>
                            <tr>
                                 <td style=" padding: 0px 20px 10px 20px; text-align: center">
                                    <a href="" class="btn btn-success">{{$email_data['user_email']}}</a>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                 <td style=" padding: 0px 20px 10px 20px; overflow: hidden; box-sizing: border-box;">
                                     ...
                                     If you did not change your {{$email_data['topic1']}}, someone might be using your account. Reset your password immediately and please <a href="#">contact myBlog</a>
                                     </p>
                                 </td>
                            </tr>
                        </table>
