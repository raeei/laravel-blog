                        ...
                        <table class="column" style="background-color: white; width: 100%; border-spacing: 0; table-layout: fixed; border-radius: 3px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015);">
                            <tr >
                                <td style=" padding: 40px 20px 10px 20px;">
                                    <p style="font-size: 17px; color: #718096;"><strong>Hello {{$email_data['name']}}, was this you?</strong></p>
                                </td>
                            </tr>
                             <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="font-size: 17px; color: #718096;">We detected a login to your myBlog account from a new device.</p>
                                </td>
                            </tr>
                            <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="font-size: 17px; color: #718096;">
                                        <strong>IP Address:</strong> {{$email_data['userIp']}}<br>
                                        <strong>Location:</strong> {{$email_data['city']}}, {{$email_data['country']}}<br>
                                        <strong>Date & Time:</strong> {{$email_data['date']}} <br>
                                        <strong>Device Type:</strong> {{$email_data['device_type']}} <br>
                                        <strong>Device Name:</strong> {{$email_data['device_name']}} / {{$email_data['device_os']}} / {{$email_data['device_browser']}}
                                    </p>
                                </td>
                            </tr>
                            <tr>
                             ...
                             <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="font-size: 15px; color: #718096;">We noticed a recent login to your myBlog account ubong from a new location or device.</p>
                                </td>
                            </tr>
                             <tr>
                                 <td style=" padding: 20px 20px 10px 20px;">
                                     <p style="font-size: 15px; color: #718096;">If this was you, no further action is required. If you do not recognize this activity at the time or IP address stated above, please <a href="http://127.0.0.1:8000/password/reset">reset your
                                             password </a>and contact <a href="">customer support</a> immediately.</p>
                                </td>
                            </tr>
                            <tr>
                                 <td style=" padding: 0px 20px 40px 20px;">
