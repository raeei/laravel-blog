    ...
    <body>
        <center class="wrapper" >
            <table class="main" width="100%">
                <tr>
                    <td height="20" class="text-center">
                        <a href=""><img src="../images/logo1.png" height="80px" width="80px"/></a>
                            ...
                            <tr >
                             ...
                             <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="font-size: 16px; color: #718096;">You've successfully registered on our great platform. We're happy to welcome you here.</p>
                                </td>
                            </tr>
                            <tr >
                                <td style=" padding: 0px 20px 10px 20px;">
                                    <p style="color: #718096;"><strong>Please verify the email address used with your myBlog account by clicking the button below:</strong></p>
                                </td>
                               
                            </tr>
                            <tr>
                                 <td style=" padding: 0px 20px 10px 20px; text-align: center">
                                    <a href="{{$url}}" class="btn btn-success">Verify your email address</a>
                                </td>
                            </tr>
                             <tr>
                                 <td style=" padding: 20px 20px 10px 20px;">
                                     <p style="font-size: 16px; color: #718096;">If you did not create an account, no further action is required.</p>
                                </td>
                            </tr>
                            <tr>
...
copy and paste the URL below into your web browser: <span class="break-all" style="box-sizing: border-box; word-break: break-all;"> <a target="_blank" style="box-sizing: border-box; position: relative" href="{{$url}}">
      {{$url}}</a></span>
                                     </p>
                                 </td>
                            </tr>
